...
public class Game {
    ...
    public void initializeNewGame() {
        ...
        manager.addEncounter(new Combat(player, new Enemy("Markus", 30, 5, 5, 1), new Armor("Armor of Sir Jean Paul Gautier", 25)));
        ...
        manager.addEncounter(new Combat(player, new Enemy("Victoria", 50, 10, 10, 2), new Weapon("Vampire's Bane", 50)));
        ...
        manager.addEncounter(new Combat(player, new Enemy("Lord Danil", 200, 25, 25, 3), new Armor("Viva la Vida", 100)));
    }
